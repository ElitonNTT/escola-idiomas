...
export default function HeaderCourse({
  ...
  return (
    <div className="mb-[35%] flex h-[40%] flex-col sm:hidden sm:h-[100%] sm:max-h-[80%]">
      ...
      <div className=" relative top-[15.5vh] z-50 mb-4 mt-auto w-full flex-1  bg-gradient-to-t from-blueprimary from-80% p-4 text-secondary sm:top-[2vh] sm:-mt-[15vh] sm:h-[100%] sm:max-h-[80%] md:flex md:flex-col">
        <div className="mb-2 ">
